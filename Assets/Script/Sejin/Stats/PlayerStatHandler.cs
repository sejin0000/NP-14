...
public class PlayerStatHandler : MonoBehaviour
{
    ...
    // curHP { get { return curHP;  } = 겟=curhp를 리턴 curhp= get  get= return curhp ==무한루프
    private float currentHp;
    [HideInInspector] public float curHP { get { return currentHp;  } set { if (value > HP.total) currentHp = HP.total;  } } //현재 체력
