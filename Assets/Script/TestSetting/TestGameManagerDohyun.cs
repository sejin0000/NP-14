...
public class TestGameManagerDohyun : MonoBehaviourPun
{
    ...
    private void SpawnPlayer()
    {
        ...
        int tempViewID = characterSetting.viewID;
        InstantiatedPlayer.GetComponent<PhotonView>().RPC("AttachMiniHUD", RpcTarget.All, tempViewID);
